...
<html lang="en">
  <head>
    ...
    <style>
		...
		a.list-group-item{color: #666 !important;}
  ...
  <body>
    <nav class = "navbar navbar-default navbar-fixed-top">
    	<div class="container-fluid">
            <div class="navbar-header">
                ...
                <div class="navbar-brand"><a href="http://stanforddaily.com"><img src="/images/daily-small.jpg" title="The Stanford Daily" style="height: 32px; margin-top: -7px;" /></a></div>
            </div>
            ...
            <div class="row">
                ...
                <div class = "col-md-3">
                    ...
                    <h4>
                        ...
                        Confirmed annual visits from the San Francisco Bay Area</p>
                    </h4>
                </div>
                <div class = "col-md-3">
               		<h3>Email Digests</h3>
    ...
    <section class="page-section" id="Digests">
    	<div class="container">
            ...
            <div class="row">
            	<div class="col-md-5">
                	<img src="images/stanford-daily-digest.jpg" title="Stanford Daily email digest" alt="Stanford Daily email digest" style="max-width: 100%" />
                </div>
                <div class="col-md-7">
                	<h4>
